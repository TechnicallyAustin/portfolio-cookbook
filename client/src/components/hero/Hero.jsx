...
export default function Hero() {
    return (
      <>
        <HeroHeader />
        <main className="w-full h-full absolute z-10 top-0 flex flex-col gap-3">
          <header className="w-full h-1/4 absolute top-1/4 z-20 flex flex-wrap justify-around bg-black bg-opacity-30 p-3">
            ...
            <article className="w-full h-1/6 flex justify-between  items-center gap-3">
              <button className="w-5/6 py-3 rounded-lg  bg-gradient-to-r from-success to-white  text-black shadow shadow-xl">
                <Link to="/home">Home</Link>
              </button>
              <button className="w-5/6 py-3 rounded-lg shadow shadow-xl bg-gradient-to-r from-success to-white bg-clip text-">
                  Learn More
              </button>
            </article>
          </header>
